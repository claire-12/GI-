            ...
            <div class="accordion" id="accordionFilterBlog">
                            ...
                            <div class="accordion" id="accordionPanelsStayOpenExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseOne"
                                        ...
                                        <div class="accordion-body">
                                            <div class="accordion-item filter-checkbox filter-attribute filter-inches_id">
                                            ...
                                            <div class="accordion-item filter-checkbox filter-attribute filter-inches_od">
                                            ...
                                            <div class="accordion-item filter-checkbox filter-attribute filter-inches_width">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseTwo"
                                        ...
                                        <div class="accordion-body">
                                            <div class="accordion-item filter-checkbox filter-attribute filter-milimeters_id">
                                            ...
                                            <div class="accordion-item filter-checkbox filter-attribute filter-milimeters_od">
                                                <h2 class="accordion-header"
                                            ...
                                            <div class="accordion-item filter-checkbox filter-attribute filter-milimeters_width">
                                                <h2 class="accordion-header"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="custom-size" placeholder="Width:"
                                                               name="attributes[nominal_size_width]">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="custom-size" placeholder="ID:"
                                                               name="attributes[nominal_size_id]">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="custom-size" placeholder="OD:"
                ...
                <?php if (!empty($attributes)): ?>
                    <?php foreach ($attributes as $slug => $attribute): ?>
                        ...
                        <?php else: if (empty($attribute['choices'])) {continue;} ?>
