                    ...
                    <div class="multisteps-form__form" id="customer_details">
                        ...
                        <div class="multisteps-form__panel js-active" data-animation="scaleIn">
                            <div class="multisteps-form__content shipping-address-content">
                                <div class="row">
                                    <div class="col-12">
                                        <a class="add-new-address-checkout" onclick="thmaf_add_new_shipping_address(event, this,'shipping')">Add a new address</a>
                                ...
                                <div class="button-row wp-block-button block-button-black d-flex mt-4">
                                    <button class="ml-auto js-btn-next submit-shipping-step wp-element-button" type="button" title="<?php _e('Continue', 'cabling') ?>"><?php _e('Continue', 'cabling') ?></button>
                                </div>
                            </div>
                        </div>
                        <!--single form panel-->
