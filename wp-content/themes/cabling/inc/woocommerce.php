...
<?php
            ...
            if (!function_exists('cabling_woocommerce_cart_link')) {
                ...
                {
?>
    <a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'cabling'); ?>">
        <?php
            ...
            <div id="collapse-<?php echo $key; ?>" class="collapse" data-parent="#accordion">
                <div class="card-body">
                    <ul class="list-file-download">
                        ...
                        <li><a href="<?php echo $doc["file"]["url"]; ?>" download><?php echo __('Download', 'cabling'); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
