    ...
    <div class="wrap-inner container">
        ...
        <form id="form-request-quote" class="form-request-quote <?php echo $is_user_logged_in ? '' : 'hidden' ?>"
            ...
            <div class="row gx-5">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-12 col-lg-6 <?php echo $is_user_logged_in ? 'hidden' : '' ?>">
                            ...
                            <div class="mb-3 form-group">
                                <input type="text" class="form-control" name="company" id="company-name"
                                       ...
                                       required>
                                <label for="company-name" class="form-label">Company name<span class="required">*</span></label>
                            </div>
                            <div class="mb-3 form-group">
                            ...
                            <div class="mb-3 form-group">
                                <input type="email" class="form-control" name="email" id="email"
                                       ...
                                       required>
                                <label for="email" class="form-label">Professional Email<span class="required">*</span></label>
                            </div>
                            <div class="mb-3 form-group form-phone">
                                ...
                                <label for="phone" class="form-label">Professional Mobile number<span class="required">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 <?php echo $is_user_logged_in ? 'hidden' : '' ?>">
                            ...
                            <div class="mb-3 form-group">
                                <input type="text" class="form-control" name="billing_address_1" id="company-street"
                                       ...
                                       required>
                                <label for="company-street" class="form-label">Company Address<span class="required">*</span></label>
                            </div>
                            <div class="mb-3 form-group">
                                <label for="company-city" class="form-label">Company City<span class="required">*</span></label>
                                <input type="text" class="form-control" name="billing_city" id="company-city"
                                       value="<?php echo $billing_city ?? '' ?>"
                                       required>
                            </div>
                            <div class="mb-3 form-group">
                                <input type="text" class="form-control" name="billing_postcode" id="company-postcode"
                                       value="<?php echo $billing_postcode ?? '' ?>"
                                       required>
                                <label for="company-postcode" class="form-label">Company Postcode<span class="required">*</span></label>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="wp-block-button block-button-black continue-step-2" style="text-align: right">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="mb-3 form-group">
                            <input type="text" class="form-control" name="product-of-interest" id="product-of-interest"
                                   ...
                                   required>
                            <label for="product-of-interest" class="form-label">Product of Interest<span class="required">*</span></label>
                        </div>
                        <div class="mb-3 form-group">
                            <input type="text" class="form-control" name="when-needed" id="when-needed"
                                   value="<?php echo $when_needed ?? '' ?>"
                                   required>
                            <label for="when-needed" class="form-label">When Needed<span class="required">*</span></label>
                        </div>
                        <div class="mb-3 form-group">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            >
                            <label for="part-number" class="form-label">Part number (if known): <span class="help">XXX</span></label>
                        </div>
                        <div class="mb-3 upload-files box p-3">
                            <label for="file" class="form-label">Upload a diagram:</label>
                            <div class="dropzone" id="dropzone">
                                <i class="fa-regular fa-arrow-up-from-bracket"></i>
                                <p class="mb-0">Drag & Drop or <a href="javascript:void(0)">Choose file</a> to upload</p>
                    ...
                    <div class="col-md-12 col-lg-6 d-flex"
                        ...
                        <!--<div class="product-block">
                            <?php /*if (!empty($post)): */?>
                                ...
                                <h3 class="mb-3"><?php /*echo get_the_title($post->ID) */?></h3>
                            <?php /*endif */?>
                            <?php /*if (!empty($product)): */?>
                                <div class="product-img mb-3">
                                    <?php /*echo get_the_post_thumbnail($product->get_id(), 'full') */?>
                                </div>
                                <h3 class="mb-3 ps-3"><?php /*echo $product->get_name() */?></h3>
                                <?php /*cabling_woocommerce_pdf_document($product) */?>
                            <?php /*endif */?>
                        </div>-->
                        <div class="o-ring-block position-relative">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                >
                                <label for="material" class="form-label">Material: <span class="help">Buna-N</span></label>
                            </div>
                            <div class="mb-3 form-group">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                >
                                <label for="temperature" class="form-label">Temperature: <span class="help">-40° - 250°C</span></label>
                            </div>
                            <div class="mb-3 form-group">
                                <input type="text" class="form-control" name="o_ring[compound]" id="compound"
                                       value="<?php echo $compound ?? '' ?>"
                                >
                                <label for="compound" class="form-label">Compound: <span class="help">Nitrile</span></label>
                            </div>
