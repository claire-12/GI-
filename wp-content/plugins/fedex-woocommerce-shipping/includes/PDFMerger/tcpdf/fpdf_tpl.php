...
class FPDF_TPL extends PH_FEDEX_FPDF {
    /**
     * Array of Tpl-Data
     * @var array
     */
    ...
    function beginTemplate($x = null, $y = null, $w = null, $h = null) {
    	if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
    ...
    function endTemplate() {
    	if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_FEDEX_TCPDF','endTemplate'), $args);
        }
    ...
    public function SetFont($family, $style = '', $size = 0, $fontfile='', $subset='default', $out=true) {
        if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_FEDEX_TCPDF','SetFont'), $args);
        }
    ...
    function Image(
        ...
        if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_FEDEX_TCPDF','Image'), $args);
        }
    ...
    function AddPage($orientation = '', $format = '', $keepmargins = false, $tocpage = false) {
    	if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_FEDEX_TCPDF','AddPage'), $args);
        }
    ...
    function Link($x, $y, $w, $h, $link, $spaces = 0) {
        if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array( 'PH_FEDEX_TCPDF','Link'), $args);
        }
    ...
    function AddLink() {
    	if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_FEDEX_TCPDF','AddLink'), $args);
        }
    ...
    function SetLink($link, $y = 0, $page = -1) {
    	if (is_subclass_of($this, 'PH_FEDEX_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_FEDEX_TCPDF','SetLink'), $args);
        }
