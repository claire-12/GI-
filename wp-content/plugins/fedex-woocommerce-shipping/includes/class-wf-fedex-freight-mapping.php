...
class WF_Fedex_Freight_Mapping {
	...
	public function add_form() {
		...
		<div class="form-field">
			<label for="fedex_freight_class"><?php _e( 'Fedex Freight Class', 'ph-fedex-woocommerce-shipping' ); ?></label>
			<select id="fedex_freight_class" name="fedex_freight_class" class="postform">
				<option value=""><?php _e( 'Default', 'ph-fedex-woocommerce-shipping' ); ?></option>
	...
	public function edit_form( $term, $taxonomy ) {
		...
		?>
		<tr class="form-field">
			<th scope="row" valign="top"><label for="fedex_freight_class"><?php _e( 'Fedex Freight Class', 'ph-fedex-woocommerce-shipping' ); ?></label></th>
			<td>
				<select id="fedex_freight_class" name="fedex_freight_class" class="postform">
					<option value=""><?php _e( 'Default', 'ph-fedex-woocommerce-shipping' ); ?></option>
					<?php foreach ( $this->classes as $key => $value ) : ?>
	...
	public function columns( $columns ) {
		$columns['fedex_freight_class'] = __( 'Fedex Freight Class', 'ph-fedex-woocommerce-shipping' );
