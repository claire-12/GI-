...
class wfFedexRequest{
	 ...
	 * Versions Variables
	 */
	public $rateservice_version, $ship_service_version, $addressvalidationservice_version;
	/**
	 * Account Number
	 */
	public $account_number;
	/**
	 * Charges Payment Type
	 */
	public $charges_payment_type;
	/**
	 * Shipping Payor Details Variables
	 */
	public $shipping_payor_acc_no, $shipping_payor_cname, $shipp_payor_company, $shipping_payor_phone, $shipping_payor_email, $shipp_payor_address1, $shipp_payor_address2, $shipping_payor_city, $shipping_payor_state, $shipping_payor_zip, $shipp_payor_country, $shipper_person_name, $shipper_company_name, $shipper_street, $shipper_street_2, $shipper_city;
	/**
	 * Shipper Variables
	 */
	public $origin, $shipper_phone_number, $shipper_email, $package, $acc_no, $freight_acc_number, $freight_enabled, $origin_country, $origin_state;
	...
	public function get_shipping_charges_payment( $request_type ){
		...
		$from_address =  apply_filters( 'wf_filter_label_from_address', $shipperAddress , $this->package );

		// To support FedEx Multi-warehouse addon
		$from_address = ( isset( $from_address['acc_no'] ) && !empty( $from_address['acc_no'] ) ) ? $from_address : $shipperAddress;
